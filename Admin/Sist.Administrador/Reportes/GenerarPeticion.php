...
$dir         = $_SERVER['DOCUMENT_ROOT'] . "/ws_dev/TareasProg/PDF/CLIENTES/" . $_GET['user_id'] . "/" . $_GET['fecha1'] . ".pdf";
...
?>
    ...
    <script>
        $(document).ready(function() {
            CargarAjax2('../ws_dev/TareasProg/GenerarReporteAseguradoraPdf_Global_VIA.php?fecha1=<?= trim($_GET['fecha1']) ?>&fecha2=<?= trim($_GET['fecha2']) ?>&user_id=<?= trim($_GET['user_id']) ?>', '', 'GET', 'manejo');
