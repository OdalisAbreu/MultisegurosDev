...
<div class="row" >
                <div class="col-lg-10" style="margin-top:-35px;">
                    <h3 class="page-header">Listados de Tarifas de:  <a onClick="CargarAjax2('Admin/Sist.Administrador/Seguros/Tarifas/List/listado.php?tarifaid=<?=$_GET['tarifaid']; ?>','','GET','cargaajax');" ><?=NombreSeguroS($_GET['tarifaid'])?></a></h3>
                </div>
            
            <div class="col-lg-2" style=" margin-top:10px;">
            <a onClick="CargarAjax2('Admin/Sist.Administrador/Seguros/Tarifas/List/listado.php?tarifaid=<?=$_GET['tarifaid']; ?>','','GET','cargaajax');" class="btn btn-info">
             <i class="fa fa-list fa-lg"></i></a>
            <a  onClick="CargarAjax_win('Admin/Sist.Administrador/Seguros/Tarifas/Edit/editar-registar.php?accion=registrar','','GET','cargaajax');"  class="btn btn-primary">
  ...
  <? 
	...
	$t['numTras'] = '0';
 $query=mysql_query("SELECT * FROM seguro_tarifas WHERE id_dist ='".$_SESSION['user_id']."' AND tipo ='".$_GET['tarifaid']."' order by id ASC");
...
<tr>
    ...
    <td>
     ...
     <!--editar -->
            <a href="javascript:" onclick="CargarAjax_win('Admin/Sist.Administrador/Seguros/Tarifas/Edit/editar-registar.php?id=<?=$row['id']; ?>&pagina=<?=$pagina?>&tarifaid=<?=$_GET['tarifaid']; ?>','','GET','cargaajax');" data-title="Editar"  class="btn btn-info">
