...
$dir			= "../../../../../../ws_dev/TareasProg/PDF/IMPRIMIR/" . $polizaNum . ".pdf";
...
if (file_exists($dir)) {
	...
	$getWS 	= file_get_contents("https://multiseguros.com.do/ws_dev/TareasProg/GenerarReporteAseguradoraPdfUnicoVIA.php?id_trans=" . $_GET['id_trans'] . "");
