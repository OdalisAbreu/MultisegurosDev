...
<div id="ver">
    ...
    margin-bottom: 0px;">
							...
							<?
							$direct	= $_SERVER['DOCUMENT_ROOT'] . "/ws_dev/TareasProg/PDF/IMPRIMIR/" . $polizaNum . ".pdf";
							...
							?>
								...
								<script>
									$(document).ready(function() {
										CargarAjax2('../ws_dev/TareasProg/GenerarReporteAseguradoraPdfUnicoVIA.php?id_trans=<?= $_GET['id_trans'] ?>', '', 'GET', 'manejo');
