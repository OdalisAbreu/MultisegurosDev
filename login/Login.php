...
if ($_SESSION['user_id']) {
    ...
    if ($func2 == '1') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Administrador";
    } elseif ($func2 == '2') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Distribuidor";
    } elseif ($func2 == '3') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Sucursal";
    } elseif ($func2 == '34') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Recargadores";
    } elseif ($func2 == '35') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Promotor";
    } elseif ($func2 == '36') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Suplidor";
    } elseif ($func2 == '37') {
        $irUrl2 = "/Seg_V2Dev/Inic.java?op=P/Dependientes";
    }
    /*
    ...
    <div class="container">
        <div class="row">
            <div align="center" style="margin-bottom: -3%; margin-top: 4%;">
                <img src="https://multiseguros.com.do/Seg_V2Dev/images/logo.png" alt="" />
            </div>
