...
<li><a href="#" onClick="CargarAjax2('Admin/Sist.Administrador/Grupos/List/listado.php','','GET','cargaajax');"><i class="fa fa-tag fa-fw"></i> Grupos</a></li>-->
  ...
  <li>
    ...
    <ul class="nav nav-second-level">
      ...
      <li><a href="#" onClick="CargarAjax2('../ws_dev/Seguros/UpdateHistorial.php','','GET','cargaajax');"><i class="fa fa-tag fa-fw"></i> Act. Hist. Vent. </a></li>


      <li><a href="#" onClick="CargarAjax2('../ws_dev/Seguros/UpdateHistorialServicios.php','','GET','cargaajax');"><i class="fa fa-tag fa-fw"></i> Act. Hist. Serv. </a></li>
